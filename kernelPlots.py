...
# Parameters to test, best parameters only
alphas = [0.27]
degrees = [1]
gammas = [0.27]
...
# registered rider vs day
XPlot = np.copy(X_finalTest[:,1])
yPlot = yFinalPredict[XPlot.argsort()]
XPlot.sort()

#plt.scatter(X_train[:,1] * 365, y_train)
plt.scatter(X_finalTest[:,1] * 365, y_finalTest)
#plt.scatter(X_finalTest[:,1] * 365, y_finalTest, color='lime')
#plt.scatter(XPlot * 365, yPlot, color='r')
plt.plot(XPlot * 365, yPlot, color='r')
plt.xlabel('Day')

"""
# Temperature
XPlot = np.copy(X_finalTest[:,2])
yPlot = yFinalPredict[XPlot.argsort()]
XPlot.sort()

plt.scatter(X_finalTest[:,2] * 41, y_finalTest)
plt.plot(XPlot * 41, yPlot, color='r')
plt.xlabel('Temperature')
"""
"""
# Humidity
XPlot = np.copy(X_finalTest[:,3])
yPlot = yFinalPredict[XPlot.argsort()]
XPlot.sort()

plt.scatter(X_finalTest[:,3] * 100, y_finalTest)
plt.plot(XPlot * 100, yPlot, color='r')
plt.xlabel('Humidity')
"""
"""
# Wind speed
XPlot = np.copy(X_finalTest[:,4])
yPlot = yFinalPredict[XPlot.argsort()]
XPlot.sort()

plt.scatter(X_finalTest[:,4] * 67, y_finalTest)
plt.plot(XPlot * 67, yPlot, color='r')
